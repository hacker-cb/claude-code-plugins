...
the required gates pass>, and whatever it or a stop above it leaves to decide
goes to <whom> — settled here too, both halves, so don't default either.
<Or: this order lands nothing and carries none.>
