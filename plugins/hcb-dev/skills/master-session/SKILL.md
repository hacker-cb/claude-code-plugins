...
- an **architectural fork** that changes what is built — §1's test, never a
  judgement about how important it looks;
...
- a **merge into the default branch** the epic's authority did not already carry
  ([`../../references/slice-completion.md`](../../references/slice-completion.md)),
  and anything irreversible reaching outside the epic.
