...
Every event opens with this session's tree moved onto the base's tip (`master-tree.md`)
before anything in it is read — what that move names as landed is a landing, below, whoever
reported it or none did — and lands in a ledger before the conversation moves on
