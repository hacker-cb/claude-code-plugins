...
before any code is read. Then the live
...
see are chased by the comms ladder, not assumed dead — and a chip not yet clicked is a
click the user owes (the epic's expectations), never a session lost.
...
- [`references/master-tree.md`](references/master-tree.md)
