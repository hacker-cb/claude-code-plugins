...
see are chased by the comms ladder, not assumed dead — and a `chipped` row with no session
goes to the user as the click they owe, never taken for a session lost or a batch failed.
