...
| | GitHub | GitLab |
|---|---|---|
| whether the tracker is there at all | `has_issues` on [the repository](https://docs.github.com/en/rest/repos/repos.md), `hasIssuesEnabled` through `gh repo view --json` | `issues_access_level` on [the project](https://docs.gitlab.com/api/projects/index.md) — a string, and `issues_enabled` beside it is the deprecated boolean |
