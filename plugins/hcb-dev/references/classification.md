...
| parked reason | at most one | the pending trigger that should reopen attention — a decision, an upstream release, a dependency the tracker cannot link ([`issue-links.md`](issue-links.md)). **Absence means ready to pick up** |
